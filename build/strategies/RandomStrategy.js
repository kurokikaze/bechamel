                ...
                switch (step) {
                    case STEP_NAME.PRS1: {
                        ...
                        if (playable.some(card => !relics.includes(card._card.name))) {
                            ...
                            if (playableRelic) {
                                this.play(playableRelic === null || playableRelic === void 0 ? void 0 : playableRelic.id);
                            }
                            return this.pass();
                        }
                        return this.pass();
                    ...
                    case STEP_NAME.ATTACK: {
                        ...
                        if (myCreatures.length) {
                            ...
                            if (enemyCreatures.length) {
                                ...
                                if (((_a = randomMy._card) === null || _a === void 0 ? void 0 : _a.data.canAttackMagiDirectly) && randomMy.data.energy <= opponentMagi.data.energy) {
...
RandomStrategy.deckId = '5f60e45e11283f7c98d9259b';
